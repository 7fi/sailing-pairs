...
const people = {
  ...
  'NU Fall 2024': {
    Varsity: [
      { name: 'Abagail', skipper: true, crew: false, partner: '' },
      { name: 'Adrian', skipper: true, crew: false, partner: '' },
      { name: 'Adrien', skipper: true, crew: false, partner: '' },
      { name: 'Adytia', skipper: true, crew: false, partner: '' },
      { name: 'Aidan', skipper: true, crew: false, partner: '' },
      { name: 'Alexander', skipper: true, crew: false, partner: '' },
      ...
      { name: 'Emma', skipper: false, crew: true, partner: '' },
      { name: 'Eva', skipper: true, crew: false, partner: '' },
      ...
      { name: 'Jack', skipper: true, crew: false, partner: '' },
      { name: 'Josh', skipper: false, crew: true, partner: '' },
      { name: 'Katherine', skipper: true, crew: false, partner: '' },
      { name: 'Lucia', skipper: true, crew: false, partner: '' },
      { name: 'Lila', skipper: true, crew: false, partner: '' },
      { name: 'Lorelei', skipper: true, crew: false, partner: '' },
      { name: 'Lucy', skipper: true, crew: false, partner: '' },
      { name: 'Peter', skipper: true, crew: false, partner: '' },
      { name: 'Max', skipper: true, crew: false, partner: '' },
      { name: 'Matthew', skipper: true, crew: false, partner: '' },
      { name: 'Olivia', skipper: true, crew: false, partner: '' },
      { name: 'Ollie', skipper: true, crew: false, partner: '' },
      { name: 'Ryan G', skipper: true, crew: false, partner: '' },
      { name: 'Ryan T', skipper: true, crew: false, partner: '' },
      ...
      { name: 'Tyler', skipper: true, crew: false, partner: '' },
      { name: 'Zachary', skipper: true, crew: false, partner: '' },
      { name: 'Zoe', skipper: false, crew: true, partner: '' },
    ],
    'Jr. Varsity': [{ name: 'Nobody :)' }],
  },
}
